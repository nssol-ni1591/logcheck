...
public class SiteListBeanImpl extends IspList implements SiteListBean {

	private final String siteName;
	private final String siteDelFlag;
	private final String projDelFlag;

	public SiteListBeanImpl(String siteId, String siteName, String siteDelFlag, String projId, String projDelFlag) {
		super(siteId, projId);
