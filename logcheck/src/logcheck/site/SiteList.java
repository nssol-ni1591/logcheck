 ...
 */
//@Alternative
public class SiteList extends LinkedHashMap<String, SiteListBean> implements UserList<SiteListBean> {

	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(SiteList.class.getName());
/*
...
*/
	...
	public SiteList load() throws Exception {
		return load(SQL_ALL_SITE);
	}

	@WithElaps
	public SiteList load(String sql) throws Exception {
				...
				)
		{
			...
			while (rs.next()) {
				...
				SiteListBean site = this.get(siteId);
				if (site == null) {
					site = new SiteListBeanImpl(siteId, siteName, siteDelFlag, projId, projDelFlag);
