 ...
 */
public class Checker6a extends AbstractChecker<Map<String, Map<IspList, Map<String, Map<NetAddr, Integer>>>>> {
		...
		map.forEach((country, ispmap) -> {
			...
			ispmap.forEach((isp, msgmap) -> {
				...
				msgmap.forEach((msg, addrmap) -> {
					...
					out.println(String.format("\t\t[ %s ] : %d" ,msg ,sum3));
	...
	public static void main(String... argv) {
		int rc = new WeldWrapper(Checker6a.class).weld(2, argv);
		System.exit(rc);
	}
}
